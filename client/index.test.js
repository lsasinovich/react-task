...
describe('actions', function () {
    ...
    it('should create an action to get movie', () => {
        ...
        fetchMock
        .getOnce(`http://react-cdp-api.herokuapp.com/movies?sortBy=sort&sortOrder=desc&search=input&searchBy=title&limit=12`, 
        mockResults);
    ...
    it('should create an action to full load', () => {
        ...
        fetchMock
        .getOnce('http://react-cdp-api.herokuapp.com/movies/123456', 
        mockResults);
    ...
    it('should create an action to switch sort', () => {
        ...
        fetchMock
        .getOnce('http://react-cdp-api.herokuapp.com/movies?sortBy=release_date&sortOrder=desc&search=inputValue&searchBy=title&limit=12', 
            mockResults);
